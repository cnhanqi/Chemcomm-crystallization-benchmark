...
The data supporting this article are derived from publicly available crystallographic records in the Protein Data Bank (PDB; https://www.rcsb.org/) and the associated PDBx/mmCIF metadata. The PDB accession codes used in the analysis are listed in the supporting data tables and Supplementary Information. Curated summary benchmark tables, figure source data, summary model-evaluation outputs and selected Python scripts used to generate the analyses and figures are available in a public GitHub repository at https://github.com/cnhanqi/Chemcomm-crystallization-benchmark and archived at https://doi.org/10.5281/zenodo.20711461. Supporting data for the figures and tables are also included in the Supplementary Information.
